     ...
     width: window.innerWidth <= 320 ? '290px' : window.innerWidth <= 360 ? '330px'  : undefined,}}>
      ...
      >
        <div className="bg-white border rounded-lg p-4 mt-2 shadow relative">
          {/* Close Icon */}
          <span onClick={onToggle} className="absolute bottom-[-15px] right-[50%] translate-x-[50%] bg-black font-dmsans text-[12px] p-2 rounded-full shadow-sm z-10 cursor-pointer">
          ...
          {/* Price Filter */}
          {/* <div className="mb-4">
            <label className="text-md font-bold mb-1 font-dmsans flex">
            ...
            {["$0 - $49.99", "$50 - $99.99", "$100+"].map((label, index) => (
              <div className="form-check flex items-center" key={index}>
                ...
                <label className="form-check-label ms-2 font-dmsans text-[14px] pt-1" htmlFor={`price-${index}`}>{label}</label>
              </div>
            ))}
          </div> */}
          ...
          {/* Piece Count */}
          <div className="mb-4">
            <label className="flex text-md font-bold mb-1 font-dmsans">
          ...
          <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> 
            ...
            {["0 - 99", "100 - 499", "500 - 999", "1000+"].map((label, index) => (
              <div className="form-check flex items-center" key={index}>
                ...
                <label className="form-check-label ms-2 font-dmsans text-[14px] pt-1" htmlFor={`pieces-${index}`}>{label}</label>
              </div>
            ))}
          </div>
          ...
          <div className="mb-4">
            ...
            {["0 - 5", "6 - 9", "10 - 17", "18+"].map((label, index) => (
              <div className="form-check flex items-center" key={index}>
                ...
                <label className="form-check-label ms-2 font-dmsans text-[14px] pt-1" htmlFor={`age-${index}`}>{label}</label>
              </div>
            ))}
          </div>
           <button
              ...
              className="w-full items-center px-4 py-1 mb-2 max-[370px]:text-[13px] max-[320px]:text-[10px] text-[13px] rounded-full focus:outline-none font-dmsans bg-[#343433] text-white cursor-pointer"
            >
              Reset
            </button>
        </div>
