...
export default function Cart({ cartItem, cur }: PropType) {
  const {
    id,
    name,
    price,
  ...
  const handleClick = () => {
    router.push(`/${projectName}/product/${cartItem.id}`);
  };
    ...
    >
      ...
      >
        ...
        <Image
          className="object-contain rounded-lg
             ...
             sm:w-[150px] sm:h-[150px]     // ≥640px (small screens)
             md:w-[200px] md:h-[200px]"    // ≥768px (medium+ screens)
      ...
      <div className="card-footer flex justify-between items-center px-2 pb-3 text-[12px] text-gray-700">
        ...
        <span className="font-dmsans flex items-center space-x-1">
          ...
          <span className="font-bold text-[13px] font-battambong text-[#000000]">{age}</span>
        </span>
