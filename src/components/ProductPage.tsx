...
import { ImageSlider, SearchBar } from "@/components";
import { NavBar } from "@/components/core";
import store from "@/lib/store";
import { Menu } from "@/types/model";
import numeral from "numeral";
import Image from "next/image";
import CategoryShow from "@/app/[projectName]/category/[category]/page";
...
export default function ProductPage({ cartItem, cur }: PropType) {
  ...
  if(saveProduct){
    ...
    if (isNaN(Number(productData))) {
      ...
      router.push(`/${projectName}/category/${productData}`);
    }    
  ...
  return (
    <Provider store={store}>
      <div
        ...
        id="scroll-container"
      >
        <div className="sticky top-0 z-[1000] max-w-[575px] mx-auto mb-2">
          <NavBar title="" icons="" />
        </div>
        ...
        <div className="px-3">
          ...
          {/* Product Card */}
          <div
            className="card w-full bg-white mx-auto my-5 px-2 py-4"
