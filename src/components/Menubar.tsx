          ...
          <ul className="flex flex-wrap gap-2">
              ...
              if (item.type === "static") {
                ...
                return (
                  <li
                    ...
                    className={`font-dmsans cursor-pointer text-nowrap max-[500px]:text-[12px] text-[13px] py-[5px] px-3 w-fit rounded-full border-amber-500 border-2 transition-colors duration-200 ${
                      isStaticActive
                        ? "text-[#343433] bg-[#f9a41a]"
                        : "text-[#343433]"
                    }`}
                  >
                    {item.label}
                ...
                return (
                  <li
                    ...
                    className={`font-dmsans cursor-pointer text-nowrap max-[500px]:text-[12px] text-[13px] py-[5px] px-3 w-fit rounded-full border-amber-500 border-2 transition-colors duration-200 ${
                      isActive ? "text-[#343433] bg-[#f9a41a]" : "text-[#343433]"
                    }`}
                  >
                    {menuItem.category}
                  </li>
            ...
            {allItems.length > itemsPerThreeRows && (
              <button
                ...
                disabled={!isReady}
                className={`font-dmsans cursor-pointer bg-[#f9a41a] max-[500px]:text-[12px] text-[#343433] text-[13px] py-[5px] px-3 w-fit rounded-full border-amber-500 border-2 transition-all duration-200 ${
